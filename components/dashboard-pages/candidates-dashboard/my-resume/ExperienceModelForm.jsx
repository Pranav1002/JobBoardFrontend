...
const handleClick = async (e) => {
  ...
  try {
    ...
    const id = parsedInfo.jsId;   
      ...
      const apiUrl = api + 'jobseeker/experience/add/' + id;

      const jobRole = information.jobRole;
      ...
      const response = await fetch(apiUrl, {
          ...
          body: JSON.stringify({ jobRole, startYear, endYear, organization, description }),
      });
